...
export class AppComponent implements OnInit, OnDestroy {
    ...
    login(userFlowRequest?: RedirectRequest | PopupRequest) {
      console.log("login--->", this.msalGuardConfig.interactionType)
      console.log("next step->>>", this.msalGuardConfig.authRequest)
      console.log("3th step--->", this.authService.loginRedirect(userFlowRequest))
